...
DIR_DATA="/beegfs/gaia/tcs/ufrj_ml_u30s/dados-sinteticos/Ruido_2024/reduced"
...
python /home/src/code/workflow_control_sarray.py \
--config_idx $SLURM_ARRAY_TASK_ID 
--configs_path /home/src/all_configs.csv
